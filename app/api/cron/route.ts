...
export async function GET(request: Request) {
  try {
    ...
    if (!products) return NextResponse.json({ message: "No product fetched" }, { status: 404 });
    ...
    return NextResponse.json({ message: "Failed to get all products", error: error }, { status: 500 });
  }
}
